...
int test_calculate_ai_pitch_targets(void) {
    ...
    pc.battingTeamPlayersOnFieldCount = 9;
    gs.strikes = 0;
    gs.balls = 0;
    calculate_ai_pitch_targets(5, 1, 0, &pc, &gs, animation_freq, &limit1, &limit2);
    ...
    pc.battingTeamPlayersOnFieldCount = 1;
    gs.strikes = 0;
    gs.balls = 0;
    calculate_ai_pitch_targets(10, 0, 5, &pc, &gs, animation_freq, &limit1, &limit2);
    ...
    gs.strikes = 1;
    gs.balls = 0;
    calculate_ai_pitch_targets(0, 0, 9, &pc, &gs, animation_freq, &limit1, &limit2);
    // limit1 = (4)*3 + 5 + 0 = 17
    // limit2 = 27 - 2 + 0 + 10 = 35
    ...
    gs.strikes = 1;
    gs.balls = 0;
    calculate_ai_pitch_targets(0, 0, 8, &pc, &gs, animation_freq, &limit1, &limit2);
    // limit1 = 17
    // limit2 = 27 - 2 + 0 - 10 = 15
    ASSERT_EQ(17, limit1, "Strike/No ball var=-10 case limit1 mismatch");

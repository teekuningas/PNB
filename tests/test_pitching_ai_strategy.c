...
int test_calculate_ai_pitch_targets(void) {
    ...
    calculate_ai_pitch_targets(5, 1, 0, 9, 0, 0, animation_freq, &limit1, &limit2);
    ...
    calculate_ai_pitch_targets(10, 0, 5, 1, 0, 0, animation_freq, &limit1, &limit2);
    ...
    calculate_ai_pitch_targets(0, 0, 9, 9, 1, 0, animation_freq, &limit1, &limit2);
    // limit1 = (4)*3 + 5 + 0 = 17
    // limit2 = 27 - 2 + 0 + 10 = 35
    ...
    calculate_ai_pitch_targets(0, 0, 8, 9, 1, 0, animation_freq, &limit1, &limit2);
    // limit1 = 17
    // limit2 = 27 - 2 + 0 - 10 = 15
    ASSERT_EQ(17, limit1, "Strike/No ball var=-10 case limit1 mismatch");

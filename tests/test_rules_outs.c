...
int test_forced_out_at_first_base() {
    ...
    int result = is_runner_forced_out(1, 0, 1, 0, 0);
...
int test_safe_on_first_base() {
    ...
    int result = is_runner_forced_out(1, 1, 1, 0, 0);
...
int test_runner_at_different_base() {
    ...
    int result = is_runner_forced_out(2, 0, 1, 0, 0);
...
int test_forced_out_at_second_base() {
    ...
    int result = is_runner_forced_out(2, 0, 2, 0, 0);
...
int test_free_walk_protection() {
    ...
    int result = is_runner_forced_out(1, 0, 1, 1, 0);
...
int test_out_of_bounds_protection() {
    ...
    int result = is_runner_forced_out(1, 0, 1, 0, 1);

...
int test_forced_out_at_first_base() {
    ...
    GameState gs = {0};
    int result = is_runner_forced_out(1, 0, 1, 0, &gs);
...
int test_safe_on_first_base() {
    ...
    GameState gs = {0};
    int result = is_runner_forced_out(1, 1, 1, 0, &gs);
...
int test_runner_at_different_base() {
    ...
    GameState gs = {0};
    int result = is_runner_forced_out(2, 0, 1, 0, &gs);
...
int test_forced_out_at_second_base() {
    ...
    GameState gs = {0};
    int result = is_runner_forced_out(2, 0, 2, 0, &gs);
...
int test_free_walk_protection() {
    ...
    GameState gs = {0};
    int result = is_runner_forced_out(1, 0, 1, 1, &gs);
...
int test_regression_runner_from_base_zero() {
    ...
    GameState gs = {0};
    int result = is_runner_forced_out(0, 0, 0, 0, &gs);

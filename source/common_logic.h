...
static __inline void initializeSpatialPlayerInformation()
{
	...
	for(i = 12; i < 2*PLAYERS_IN_TEAM + JOKER_COUNT; i++)
	{
		...
		switch(i-12)
		{
			case 0: fieldPosition = &(stateInfo.fieldPositions->pitcher); break;
			case 1: fieldPosition = &(stateInfo.fieldPositions->firstBase); break;
			case 2: fieldPosition = &(stateInfo.fieldPositions->secondBase); break;
			case 3: fieldPosition = &(stateInfo.fieldPositions->thirdBase); break;
			case 4: fieldPosition = &(stateInfo.fieldPositions->bottomRightCatcher); break;
			case 5: fieldPosition = &(stateInfo.fieldPositions->middleLeftCatcher); break;
			case 6: fieldPosition = &(stateInfo.fieldPositions->middleRightCatcher); break;
...
static __inline void initializeInningPermanentPlayerInformation()
{
	...
	for(i = 12; i < 2*PLAYERS_IN_TEAM + JOKER_COUNT; i++)
	{
		...
		switch(i-12)
		{
			case 0: stateInfo.localGameInfo->pII.catcherOnBaseIndex[0] = i; break;

...
OBJ_INT  = $(patsubst %,$(ODIR)/int/%,$(_OBJ_COMMON) tests/integration/fixtures.o tests/integration/test_scenario_outs.o tests/integration/test_scenario_runs.o tests/integration/test_scenario_wounded.o tests/integration/test_scenario_chain_reaction.o tests/integration/test_scenario_tuplahaava.o)

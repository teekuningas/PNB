...
int platform_ensure_save_dir(void)
{
    ...
    result = snprintf(pnbPath, sizeof(pnbPath), "%s%sAppData%sLocal%sPNB", homedir, SEPARATOR, SEPARATOR, SEPARATOR);
...
int platform_get_save_path(char* result, size_t max_len, int slot)
{
    ...
    snprintf_result = snprintf(
        result, max_len, "%s%sAppData%sLocal%sPNB%ssaves%scup_%d.xml", homedir, SEPARATOR, SEPARATOR, SEPARATOR,
    ...
    snprintf_result =
        snprintf(result, max_len, "%s%s.pnb%ssaves%scup_%d.xml", homedir, SEPARATOR, SEPARATOR, SEPARATOR, slot);
#endif

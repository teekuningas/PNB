...
void fixture_create_super_inning(GameSetup* setup, int team1, int team2, int team1_control, int team2_control)
{
...
void fixture_create_homerun_contest(GameSetup* setup, int team1, int team2, int team1_control, int team2_control)
{
    memset(setup, 0, sizeof(GameSetup));
...
void fixture_create_cup_final_super_inning(
